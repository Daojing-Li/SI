...
def evaluate_and_plot(model_name, y_train, y_pred_train, y_test, y_pred_test, X_train, X_test, threshold=30,mae_threshold = 20,mae_mean = None):
...
def evaluate_and_plot_with_abnormal_points(model_name, y_train, y_pred_train, y_test, y_pred_test, X_train, X_test, threshold=30,mae_threshold = 20,mae_mean = None):
    """
    ...
    if mae_mean < mae_threshold:
        ...
        plt.text(100, -5, f"Train RMSE: {rmse_train:.4f}", fontsize=12, ha='right', va='bottom', fontname='Arial')   
        plt.text(100, 0, fr"Train $R^2$: {r2_train:.4f}", fontsize=12, ha='right', va='bottom', fontname='Arial')
        plt.text(100, 5, f"Train MAE: {mae_train:.4f}", fontsize=12, ha='right', va='bottom', fontname='Arial')
        plt.text(100, 10, f"Test RMSE: {rmse_test:.4f}", fontsize=12, ha='right', va='bottom', fontname='Arial')
        plt.text(100, 15, fr"Test $R^2$: {r2_test:.4f}", fontsize=12, ha='right', va='bottom', fontname='Arial')        
        plt.text(100, 20, f"Test MAE: {mae_test:.4f}", fontsize=12, ha='right', va='bottom', fontname='Arial')                                                                                                                                                                    
