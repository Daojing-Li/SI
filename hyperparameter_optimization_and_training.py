...
def hyperparameter_optimization_and_training(model_class, X, y,n_trials=100,random_state=42):
    """
    ...
    """
    mae_loo_mean, mae_mean, best_params = train_and_evaluate(model_class, X, y, random_state=42,n_trials=n_trials)
